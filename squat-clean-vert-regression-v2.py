...
data = pd.read_csv('imputed-data.csv')

# split data into features and target
X = data.drop(['First', 'Last', 'ID', 'Vert'], axis=1)
y = data['Vert']
...
# pickle model
#feature_names = ['SLVl', 'SLVr', 'BSS', 'BS', 'Clean']
feature_names = ['BSS', 'BS', 'Clean']
with open('vert_predictor.pkl', 'wb') as f:
